...
def winner(board, player):
    """
        ...
        048     246
    """
    wins = [[board[0], board[1], board[2]], [board[3], board[4], board[5]], [board[6], board[7], board[8]], # 三个水平行都为同一个
            [board[0], board[3], board[6]], [board[1], board[4], board[7]], [board[2], board[5], board[8]], # 三个竖直列都为同一个
            [board[0], board[4], board[8]], [board[2], board[4], board[6]]]                                 # 两个斜向为同一个
